...
<aside>
  <nav class="app-nav">
    <h1>
      Flashify
      <img src="/assets/flash-card.png" alt="">
    </h1>

    <hr>

    <a href="" <?php echo $stringAfterApp == "review" ? 'class=active' : '' ?>>
    ...
    <a href="" <?php echo $stringAfterApp == "" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <a href="" <?php echo $stringAfterApp == "decks" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <title>layers</title>
    ...
    <a href="" <?php echo $stringAfterApp == "cards" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <title>cards</title>
    ...
    <a href="" <?php echo $stringAfterApp == "stats" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <a href="" <?php echo $stringAfterApp == "market" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <title>store</title>
    ...
    <a href="/app/logout.php" <?php echo $stringAfterApp == "logout" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <title>logout</title>
    ...
    <a href="" <?php echo $stringAfterApp == "settings" ? 'class=active' : '' ?>>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <title>cog</title>
